...
<body class="bg-slate-50 min-h-screen">
    <div class="flex">
        ...
        <div class="flex-1 p-8">
            <h2 class="text-2xl font-bold mb-6 text-slate-800">Kelola Data Pelanggan</h2>
            ...
            <form method="POST" class="bg-white p-6 rounded-lg shadow mb-6 grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="kode_pelanggan" placeholder="e.g. PLG-001" value="<?= $data_edit['kode_pelanggan'] ?? '' ?>" required class="w-full border p-2 rounded focus:ring-2 focus:ring-blue-500">
                </div>
                <div>
